...
from hate.entity.config_entity import DataIngestionConfig,DataTransformationConfig,ModelTrainerConfig,ModelPusherConfig,ModelEvaluationConfig
from hate.entity.artifact_entity import DataIngestionArtifacts,DataTransformationArtifacts,ModelTrainerArtifacts,ModelPusherArtifacts,ModelEvaluationArtifacts
...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifacts:
        logging.info("Entered the start ingestion phase")
        try:
    ...
    def start_data_transformation(self, data_ingestion_artifacts = DataIngestionArtifacts) -> DataTransformationArtifacts:
        ...
        try:
            data_transformation = DataTransformation(
                ...
                data_transformation_config=self.data_transormation_config
            )
    ...
    def run_pipeline(self):
        ...
        try:
            ...
            model_evaluation_artifacts=self.start_model_evaluation(
                model_trainer_artifacts=model_trainer_artifacts,data_transformation_artifacts=data_transformation_artifacts
            )
            if not model_evaluation_artifacts.is_model_accepted:
